...
const Cards = () => {
    return (
        <div className='w-full h-screen bg-zinc-900 pt-1 px-10'>
            <div className='flex gap-5 mt-32'>
                ...
                <div className="flex w-1/2 gap-5">
                    <div className="card cursor-pointer relative rounded-xl flex flex-col justify-between w-1/2 h-96 p-5 bg-[#253a37]">
